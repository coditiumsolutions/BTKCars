        ...
        <div className="footer-grid">
          ...
          <div className="footer-section">
            <h3 className="footer-brand">
              BTK<span className="footer-brand-accent">Cars</span>
            </h3>
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <Link to="/buy" className="footer-link">
                Buy a Car
              </Link>
          ...
          <div className="footer-section">
            ...
            <div className="footer-contact">
              <div className="footer-contact-item">
                ...
                <span>Shop number 5, ZA Heights. Opposite Head Office of BTK, Bahria Town Karachi.</span>
              </div>
              <div className="footer-contact-item">
                <svg
                  className="footer-contact-icon"
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-container">
          <p className="footer-copyright">
            &copy; {new Date().getFullYear()} BTKCars. All rights reserved.
          </p>
